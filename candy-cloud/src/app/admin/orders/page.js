...
export default function AdminOrders() {
    ...
    const renderStatusBadge = (statusStr) => {
        ...
        if (statusStr === "placed" || statusStr === "processing" || statusStr === "Sorting") {
            label = "Sorting";
            styleStr = "bg-[#fff0db] text-[#d97706]"; // Yellow/Orange
    ...
    const getInitialsBg = (name) => {
        const colors = ["bg-pink-100 text-pink-600", "bg-teal-100 text-teal-600", "bg-orange-100 text-orange-600", "bg-purple-100 text-purple-600", "bg-blue-100 text-blue-600"];
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-[#fff9f0] rounded-2xl p-6 shadow-sm border border-[#fce9c0] relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-4 relative z-10">
                        <div className="w-10 h-10 rounded-xl bg-orange-400 flex items-center justify-center text-white shadow-sm shadow-orange-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"></path><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"></path><path d="M4 22h16"></path><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"></path><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"></path><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"></path></svg>
                        </div>
                        <span className="text-[10px] font-black text-orange-500 uppercase tracking-widest">Premium</span>
                    </div>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
                        <div className="relative flex-1 sm:w-64">
                            ...
                            <input
                                ...
                                className="w-full bg-[#f8f9fa] border border-gray-200 rounded-xl py-2.5 pl-10 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-200 focus:border-orange-500 transition-all text-gray-700"
                            />
                        </div>
                        ...
                        <select
                            ...
                            className="bg-white border border-gray-200 rounded-xl py-2.5 px-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-200 focus:border-orange-500 text-gray-700 appearance-none min-w-[140px]"
                        >
                        ...
                        <div className="relative hidden md:block">
                            <input
                                ...
                                disabled
                                className="bg-white border border-gray-200 rounded-xl py-2.5 px-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-200 focus:border-orange-500 text-gray-400 w-36 pr-10 cursor-not-allowed hidden md:block"
                            />
                        ...
                        <button
                            ...
                            className="bg-[#ea580c] hover:bg-[#c2410c] text-white rounded-xl py-2.5 px-6 text-sm font-bold flex items-center justify-center gap-2 transition-colors shadow-sm"
                        >
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center mt-6 pt-6 border-t border-gray-100 gap-4">
                    ...
                    <div className="flex gap-1.5">
                        ...
                        <button className="w-10 h-10 rounded-xl flex items-center justify-center border border-transparent bg-orange-500 text-white font-bold shadow-sm">
