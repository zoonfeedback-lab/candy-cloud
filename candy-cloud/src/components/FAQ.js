...
export default function FAQ() {
    ...
    return (
        <section id="faq" className="py-20 bg-yellow">
            <div className="max-w-[1200px] mx-auto px-5">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
                    The Magical Cloud: Myths &amp; Legends (FAQs)
                </h2>
                <p className="text-gray-500 mb-10 text-base md:text-lg max-w-[600px] mx-auto text-center">
