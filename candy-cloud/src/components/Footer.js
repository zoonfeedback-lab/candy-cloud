    ...
    return (
        <footer className="relative">
            ...
            <div className="pt-16 pb-12 relative overflow-hidden bg-gradient-to-b from-[#4f9b9b] to-[#3b8a8a]">
                ...
                <div className="max-w-[1200px] mx-auto px-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.3fr] gap-12 relative z-10">
                    {/* Brand */}
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-3 mt-2">
                            ...
                            <div className="flex items-center gap-3 text-sm text-white/90 font-medium">
                                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-white/10 backdrop-blur-sm shrink-0">📞</span>
                                <span>03199677765</span>
                            </div>
                            <div className="flex items-center gap-3 text-sm text-white/90 font-medium">
                                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-white/10 backdrop-blur-sm shrink-0">✉️</span>
